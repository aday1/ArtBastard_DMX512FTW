...
export const FancyQuotes = ({ intervalSeconds = 30, animate = true }) => {
    ...
    return (_jsxs("div", { className: `${styles.fancyQuote} ${isVisible ? styles.visible : styles.hidden}`, style: {
        ...
        }, children: [_jsx("q", { children: currentQuote?.text }), _jsxs("div", { className: styles.quoteSignature, style: { color: currentQuote?.color }, children: ["\u2014 ", currentQuote?.author] })] }));
};
