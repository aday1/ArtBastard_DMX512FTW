...
export const NetworkStatus = ({ isModal = false, onClose, compact = false }) => {
    ...
    if (compact) {
        return (_jsxs("div", { className: styles.compactView, children: [_jsxs("span", { className: styles.compactItem, children: [_jsx("i", { className: "fas fa-server" }), " ", health?.serverStatus || 'Unknown'] }), _jsxs("span", { className: styles.compactItem, children: [_jsx("i", { className: "fas fa-plug" }), " ", connected ? 'Connected' : 'Disconnected'] }), _jsxs("span", { className: styles.compactItem, children: [_jsx("i", { className: "fas fa-music" }), " ", health?.midiDevicesConnected || 0, " MIDI"] }), _jsxs("span", { className: styles.compactItem, children: [_jsx("i", { className: "fas fa-network-wired" }), " ", health?.artnetStatus || 'Unknown'] })] }));
    }
    if (isModal) {
